...
void DoText(co_stream input_stream, co_stream output_stream)
{
        ...
        do {
                ...
                co_stream_open(input_stream, 0, co_type_create(co_int_sort,8));
               
                co_stream_open(output_stream, 1, co_type_create(co_int_sort,8));
...
void config_helloworld(void *arg)
{
        ...
        s1=co_stream_create("Stream1",co_type_create(co_int_sort,8),2);
        s2=co_stream_create("Stream2",co_type_create(co_int_sort,8),2);
