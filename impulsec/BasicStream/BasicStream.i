...
# 14 "BasicStream_hw.c" 2
# 1 "BasicStream.h" 1
# 15 "BasicStream_hw.c" 2
...
void HWproc(co_stream HWinput, co_stream HWoutput)
{
        ...
        do {
                ...
                co_stream_open(HWinput, 0, co_type_create(co_int_sort,1));
                co_stream_open(HWoutput, 1, co_type_create(co_int_sort,1));
...
void config_BasicStream(void *arg)
{
        ...
        HWinput = co_stream_create("HWinput", co_type_create(co_int_sort,1), 2);
        HWoutput = co_stream_create("HWoutput", co_type_create(co_int_sort,1), 2);
