...
# 11 "BubbleSort_hw.c" 2
# 1 "BubbleSort.h" 1
# 12 "BubbleSort_hw.c" 2
...
void Sorter(co_stream input, co_stream output)
{
        ...
        do
        {
                ...
                index = 0;
                co_stream_open(input, 0, co_type_create(co_int_sort,32));
                {
                ...
                for (counter = 0; counter < NUM_LOOPS; counter++)
                {
                        for (index = 0; index < 32; index++)
                        {
                                for (innerIndex = 0; innerIndex < 32 - 1; innerIndex++)
                                {
                                        if (counter % 2 == 0)
                                        {
                ...
                co_stream_open(output, 1, co_type_create(co_int_sort,32));
                for (index = 0; index < 32; index++)
                {
...
void config_BubbleSort(void *arg)
{
        ...
        input = co_stream_create("input", co_type_create(co_int_sort,32), 32);
        output = co_stream_create("output", co_type_create(co_int_sort,32), 32);
