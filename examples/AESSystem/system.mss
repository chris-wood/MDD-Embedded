...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = plb_bubblesort_arch
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = plb_bubblesort_arch_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = plb_bubblesort_arch
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = plb_bubblesort_arch_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = plb_bubblesort_arch
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = plb_bubblesort_arch_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = plb_bubblesort_arch
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = plb_bubblesort_arch_3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = plb_bubblesort_arch
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = plb_bubblesort_arch_4
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = plb_aes_arch
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = plb_aes_arch_0
END
