...
# C:\Workspace\repo\examples\TestSystem\system.mhs
# The software specification of the system is in file :
# C:\Workspace\repo\examples\TestSystem\system.mss
...
TestApp_Memory_ppc440_0_program: $(CYG_TESTAPP_MEMORY_PPC440_0_OUTPUT) 

$(CYG_TESTAPP_MEMORY_PPC440_0_OUTPUT) : $(TESTAPP_MEMORY_PPC440_0_SOURCES) $(TESTAPP_MEMORY_PPC440_0_HEADERS) $(TESTAPP_MEMORY_PPC440_0_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/testapp_memory_ppc440_0_compiler.opt
	@mkdir -p $(TESTAPP_MEMORY_PPC440_0_OUTPUT_DIR) 
	$(TESTAPP_MEMORY_PPC440_0_CC) $(TESTAPP_MEMORY_PPC440_0_CC_OPT) $(TESTAPP_MEMORY_PPC440_0_SOURCES) -o $(CYG_TESTAPP_MEMORY_PPC440_0_OUTPUT) \
	...
	$(TESTAPP_MEMORY_PPC440_0_CC_SIZE) $(CYG_TESTAPP_MEMORY_PPC440_0_OUTPUT) 
	@echo ""
...
TestApp_Peripheral_ppc440_0_program: $(CYG_TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) 

$(CYG_TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) : $(TESTAPP_PERIPHERAL_PPC440_0_SOURCES) $(TESTAPP_PERIPHERAL_PPC440_0_HEADERS) $(TESTAPP_PERIPHERAL_PPC440_0_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/testapp_peripheral_ppc440_0_compiler.opt
	@mkdir -p $(TESTAPP_PERIPHERAL_PPC440_0_OUTPUT_DIR) 
	$(TESTAPP_PERIPHERAL_PPC440_0_CC) $(TESTAPP_PERIPHERAL_PPC440_0_CC_OPT) $(TESTAPP_PERIPHERAL_PPC440_0_SOURCES) -o $(CYG_TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) \
	...
	$(TESTAPP_PERIPHERAL_PPC440_0_CC_SIZE) $(CYG_TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) 
	@echo ""
...
bubblesort_program: $(CYG_BUBBLESORT_OUTPUT) 

$(CYG_BUBBLESORT_OUTPUT) : $(BUBBLESORT_SOURCES) $(BUBBLESORT_HEADERS) $(BUBBLESORT_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/bubblesort_compiler.opt
	@mkdir -p $(BUBBLESORT_OUTPUT_DIR) 
	$(BUBBLESORT_CC) $(BUBBLESORT_CC_OPT) $(BUBBLESORT_SOURCES) -o $(CYG_BUBBLESORT_OUTPUT) \
	$(BUBBLESORT_OTHER_CC_FLAGS) $(BUBBLESORT_INCLUDES) $(BUBBLESORT_LIBPATH) \
	$(BUBBLESORT_CFLAGS) $(BUBBLESORT_LFLAGS) 
	$(BUBBLESORT_CC_SIZE) $(CYG_BUBBLESORT_OUTPUT) 
	@echo ""

bubblesort_programclean:
	rm -f $(BUBBLESORT_OUTPUT) 
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(CYG_TESTAPP_MEMORY_PPC440_0_OUTPUT) $(CYG_TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) $(CYG_BUBBLESORT_OUTPUT) 
	@echo "*********************************************"
	@echo "Creating system ace file"
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(TESTAPP_MEMORY_PPC440_0_OUTPUT) $(TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) $(BUBBLESORT_OUTPUT)  -target ppc_hw  -ace $(SYSTEM_ACE)
