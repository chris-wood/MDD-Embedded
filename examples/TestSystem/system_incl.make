...
# Project:C:\Workspace\repo\examples\TestSystem\system.xmp
#
...
BUBBLESORT_OUTPUT_DIR = bubblesort
BUBBLESORT_OUTPUT = $(BUBBLESORT_OUTPUT_DIR)/executable.elf
CYG_BUBBLESORT_OUTPUT_DIR = bubblesort
CYG_BUBBLESORT_OUTPUT = $(CYG_BUBBLESORT_OUTPUT_DIR)/executable.elf
...
BRAMINIT_ELF_FILES =  $(CYG_BUBBLESORT_OUTPUT) 
BRAMINIT_ELF_FILE_ARGS =   -pe ppc440_0 $(BUBBLESORT_OUTPUT) 

ALL_USER_ELF_FILES = $(CYG_TESTAPP_MEMORY_PPC440_0_OUTPUT) $(CYG_TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) $(CYG_BUBBLESORT_OUTPUT) 
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -s mti -X C:/Workspace/repo/examples/TestSystem/
...
PROGRAMCLEAN_TARGETS = TestApp_Memory_ppc440_0_programclean TestApp_Peripheral_ppc440_0_programclean bubblesort_programclean 
...
pcores/plb_BubbleSort_arch_v1_00_a/hdl/vhdl/BubbleSort_comp.vhd \
pcores/plb_BubbleSort_arch_v1_00_a/hdl/vhdl/BubbleSort_top.vhd \
pcores/plb_BubbleSort_arch_v1_00_a/hdl/vhdl/plb_BubbleSort_arch.vhd \
pcores/plb_AES_arch_v1_00_a/hdl/vhdl/AES_comp.vhd \
pcores/plb_AES_arch_v1_00_a/hdl/vhdl/AES_top.vhd \
pcores/plb_AES_arch_v1_00_a/hdl/vhdl/plb_AES_arch.vhd
...
#################################################################
# SOFTWARE APPLICATION BUBBLESORT
#################################################################

BUBBLESORT_SOURCES = code/co_init.c code/BubbleSort_sw.c 

BUBBLESORT_HEADERS = code/BubbleSort.h 

BUBBLESORT_CC = powerpc-eabi-gcc
BUBBLESORT_CC_SIZE = powerpc-eabi-size
BUBBLESORT_CC_OPT = -O2
BUBBLESORT_CFLAGS = 
BUBBLESORT_CC_SEARCH = # -B
BUBBLESORT_LIBPATH = -L./ppc440_0/lib/ # -L
BUBBLESORT_INCLUDES = -I./ppc440_0/include/  -Icode/ # -I
BUBBLESORT_LFLAGS = # -l
BUBBLESORT_LINKER_SCRIPT = bubblesort/bubblesort_linker_script.ld
BUBBLESORT_LINKER_SCRIPT_FLAG = -Wl,-T -Wl,$(BUBBLESORT_LINKER_SCRIPT) 
BUBBLESORT_CC_DEBUG_FLAG =  -g 
BUBBLESORT_CC_PROFILE_FLAG = # -pg
BUBBLESORT_CC_GLOBPTR_FLAG= # -msdata=eabi
BUBBLESORT_CC_INFERRED_FLAGS= -mcpu=440 
BUBBLESORT_CC_START_ADDR_FLAG=  #  # -Wl,-defsym -Wl,_START_ADDR=
BUBBLESORT_CC_STACK_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_STACK_SIZE=
BUBBLESORT_CC_HEAP_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_HEAP_SIZE=
BUBBLESORT_OTHER_CC_FLAGS= $(BUBBLESORT_CC_GLOBPTR_FLAG)  \
                  $(BUBBLESORT_CC_START_ADDR_FLAG) $(BUBBLESORT_CC_STACK_SIZE_FLAG) $(BUBBLESORT_CC_HEAP_SIZE_FLAG)  \
                  $(BUBBLESORT_CC_INFERRED_FLAGS)  \
                  $(BUBBLESORT_LINKER_SCRIPT_FLAG) $(BUBBLESORT_CC_DEBUG_FLAG) $(BUBBLESORT_CC_PROFILE_FLAG) 
