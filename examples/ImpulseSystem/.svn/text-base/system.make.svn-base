...
# C:\Workspace\ImpulseSystem\system.mhs
# The software specification of the system is in file :
# C:\Workspace\ImpulseSystem\system.mss
...
basicstream_program: $(CYG_BASICSTREAM_OUTPUT) 

$(CYG_BASICSTREAM_OUTPUT) : $(BASICSTREAM_SOURCES) $(BASICSTREAM_HEADERS) $(BASICSTREAM_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/basicstream_compiler.opt
	@mkdir -p $(BASICSTREAM_OUTPUT_DIR) 
	$(BASICSTREAM_CC) $(BASICSTREAM_CC_OPT) $(BASICSTREAM_SOURCES) -o $(CYG_BASICSTREAM_OUTPUT) \
	$(BASICSTREAM_OTHER_CC_FLAGS) $(BASICSTREAM_INCLUDES) $(BASICSTREAM_LIBPATH) \
	$(BASICSTREAM_CFLAGS) $(BASICSTREAM_LFLAGS) 
	$(BASICSTREAM_CC_SIZE) $(CYG_BASICSTREAM_OUTPUT) 
	@echo ""

basicstream_programclean:
	rm -f $(BASICSTREAM_OUTPUT) 
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(CYG_TESTAPP_MEMORY_PPC440_0_OUTPUT) $(CYG_TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) $(CYG_BASICSTREAM_OUTPUT) 
	@echo "*********************************************"
	@echo "Creating system ace file"
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(TESTAPP_MEMORY_PPC440_0_OUTPUT) $(TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) $(BASICSTREAM_OUTPUT)  -target ppc_hw  -ace $(SYSTEM_ACE)
