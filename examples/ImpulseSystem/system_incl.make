...
# Project:C:\Workspace\ImpulseSystem\system.xmp
#
...
BASICSTREAM_OUTPUT_DIR = basicstream
BASICSTREAM_OUTPUT = $(BASICSTREAM_OUTPUT_DIR)/executable.elf
CYG_BASICSTREAM_OUTPUT_DIR = basicstream
CYG_BASICSTREAM_OUTPUT = $(CYG_BASICSTREAM_OUTPUT_DIR)/executable.elf
...
ALL_USER_ELF_FILES = $(CYG_TESTAPP_MEMORY_PPC440_0_OUTPUT) $(CYG_TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) $(CYG_BASICSTREAM_OUTPUT) 
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -s mti -X C:/Workspace/ImpulseSystem/
...
PROGRAMCLEAN_TARGETS = TestApp_Memory_ppc440_0_programclean TestApp_Peripheral_ppc440_0_programclean basicstream_programclean 

CORE_STATE_DEVELOPMENT_FILES = pcores/impulse/hdl/vhdl/divmod.vhd \
pcores/impulse/hdl/vhdl/gmem.vhd \
pcores/impulse/hdl/vhdl/fifo.vhd \
pcores/impulse/hdl/vhdl/fifo_dc.vhd \
pcores/impulse/hdl/vhdl/csignal.vhd \
pcores/impulse/hdl/vhdl/cregister.vhd \
pcores/impulse/hdl/vhdl/stream.vhd \
pcores/impulse/hdl/vhdl/stream_dc.vhd \
pcores/impulse/hdl/vhdl/impack.vhd \
pcores/impulse/hdl/vhdl/mem_if.vhd \
pcores/impulse/hdl/vhdl/plbdma4.vhd \
pcores/impulse/hdl/vhdl/plb4_if.vhd \
pcores/plb_BasicStream_arch_v1_00_a/hdl/vhdl/BasicStream_comp.vhd \
pcores/plb_BasicStream_arch_v1_00_a/hdl/vhdl/BasicStream_top.vhd \
pcores/plb_BasicStream_arch_v1_00_a/hdl/vhdl/plb_BasicStream_arch.vhd
...
TESTAPP_PERIPHERAL_PPC440_0_SOURCES = TestApp_Peripheral_ppc440_0/src/TestApp_Peripheral.c TestApp_Peripheral_ppc440_0/src/xintc_tapp_example.c TestApp_Peripheral_ppc440_0/src/xgpio_tapp_example.c TestApp_Peripheral_ppc440_0/src/xiic_selftest_example.c TestApp_Peripheral_ppc440_0/src/xtmrctr_selftest_example.c TestApp_Peripheral_ppc440_0/src/xtmrctr_intr_example.c 

TESTAPP_PERIPHERAL_PPC440_0_HEADERS = TestApp_Peripheral_ppc440_0/src/intc_header.h TestApp_Peripheral_ppc440_0/src/gpio_header.h TestApp_Peripheral_ppc440_0/src/iic_header.h TestApp_Peripheral_ppc440_0/src/tmrctr_header.h TestApp_Peripheral_ppc440_0/src/tmrctr_intr_header.h 
...
#################################################################
# SOFTWARE APPLICATION BASICSTREAM
#################################################################

BASICSTREAM_SOURCES = code/BasicStream_sw.c code/co_init.c 

BASICSTREAM_HEADERS = code/BasicStream.h 

BASICSTREAM_CC = powerpc-eabi-gcc
BASICSTREAM_CC_SIZE = powerpc-eabi-size
BASICSTREAM_CC_OPT = -O2
BASICSTREAM_CFLAGS = 
BASICSTREAM_CC_SEARCH = # -B
BASICSTREAM_LIBPATH = -L./ppc440_0/lib/ # -L
BASICSTREAM_INCLUDES = -I./ppc440_0/include/  -Icode/ # -I
BASICSTREAM_LFLAGS = # -l
BASICSTREAM_LINKER_SCRIPT = 
BASICSTREAM_LINKER_SCRIPT_FLAG = #-Wl,-T -Wl,$(BASICSTREAM_LINKER_SCRIPT) 
BASICSTREAM_CC_DEBUG_FLAG =  -g 
BASICSTREAM_CC_PROFILE_FLAG = # -pg
BASICSTREAM_CC_GLOBPTR_FLAG= # -msdata=eabi
BASICSTREAM_CC_INFERRED_FLAGS= -mcpu=440 
BASICSTREAM_CC_START_ADDR_FLAG=  # -Wl,-defsym -Wl,_START_ADDR=
BASICSTREAM_CC_STACK_SIZE_FLAG=  # -Wl,-defsym -Wl,_STACK_SIZE=
BASICSTREAM_CC_HEAP_SIZE_FLAG=  # -Wl,-defsym -Wl,_HEAP_SIZE=
BASICSTREAM_OTHER_CC_FLAGS= $(BASICSTREAM_CC_GLOBPTR_FLAG)  \
                  $(BASICSTREAM_CC_START_ADDR_FLAG) $(BASICSTREAM_CC_STACK_SIZE_FLAG) $(BASICSTREAM_CC_HEAP_SIZE_FLAG)  \
                  $(BASICSTREAM_CC_INFERRED_FLAGS)  \
                  $(BASICSTREAM_LINKER_SCRIPT_FLAG) $(BASICSTREAM_CC_DEBUG_FLAG) $(BASICSTREAM_CC_PROFILE_FLAG) 
