...
# Project:C:\Workspace\ImpulseIntegrationSystem\system.xmp
#
...
# C:\Workspace\ImpulseIntegrationSystem\system.mhs
# The software specification of the system is in file :
# C:\Workspace\ImpulseIntegrationSystem\system.mss
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(CYG_TESTAPP_MEMORY_PPC440_0_OUTPUT) $(CYG_TESTAPP_PERIPHERAL_PPC440_0_OUTPUT) 
	@echo "*********************************************"
	@echo "Creating system ace file"
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(TESTAPP_MEMORY_PPC440_0_OUTPUT) $(TESTAPP_PERIPHERAL_PPC440_0_OUTPUT)  -target ppc_hw  -ace $(SYSTEM_ACE)
