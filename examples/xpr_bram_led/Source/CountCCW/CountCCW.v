...
// rotate the button LEDs Counter Clock Wise
...
module recon_block_count (
   ...
   always @(data_out)
      case (data_out)
         4'b0001: nxt_data_out <= 4'b1000;
         4'b0010: nxt_data_out <= 4'b0001;
         4'b0100: nxt_data_out <= 4'b0010;
         4'b1000: nxt_data_out <= 4'b0100;
